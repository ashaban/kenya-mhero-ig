...
Usage:          #example
* code = IhrisResourceCodeSystem#page
* extension[display].extension[resource].valueReference = Reference(StructureDefinition/iHRISPractitioner)
...
* extension[display].extension[search][3].valueString = "Active|Practitioner.active"
...
* extension[display].extension[filter][2].valueString = "Active|active"
...
* extension[section][0].extension[field][5].valueString = "Practitioner.active"
...
* extension[section][4].extension[resource].extension[resource].valueReference = Reference(StructureDefinition/iHRISPractitionerRole)
...
Usage:          #example
* code = IhrisResourceCodeSystem#page
* extension[display].extension[resource].valueReference = Reference(StructureDefinition/iHRISPractitionerRole)
